---
title: "ECG Noise and Lead-Failure Stress-Test Corpus (v1) — Generation Report and Full Record Roster"
date: "2026-07-13"
...
header-includes:
  ...
  - \fancyfoot[L]{\small Artefaux v1.0.0}
...
| `nlf_​noise_​002` | afib | `10330_hr` | `ma` @ +0 dB | 6 | 0 | **limited** | yes |
| `nlf_​noise_​003` | pac pvc | `11089_hr` | `bw` @ +6 dB | 6 | 0 | **limited** | — |
| `nlf_​noise_​004` | bbb conduction | `11662_hr` | `em` @ +12 dB | 12 | 0 | **diagnostic** | — |
| `nlf_​noise_​005` | st t | `12086_hr` | `ma` @ +18 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​006` | flutter svt | `12407_hr` | `bw` @ -6 dB | 6 | 6 | **limited** | yes |
| `nlf_​noise_​007` | sinus | `01306_hr` | `em` @ +0 dB | 12 | 0 | **limited** | yes |
| `nlf_​noise_​008` | afib | `13114_hr` | `ma` @ +6 dB | 6 | 0 | **limited** | — |
| `nlf_​noise_​009` | pac pvc | `13332_hr` | `bw` @ +12 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​010` | bbb conduction | `13611_hr` | `em` @ +18 dB | 12 | 0 | **diagnostic** | — |
| `nlf_​noise_​011` | st t | `14071_hr` | `ma` @ -6 dB | 6 | 6 | **limited** | yes |
| `nlf_​noise_​012` | flutter svt | `14211_hr` | `bw` @ +0 dB | 6 | 0 | **limited** | yes |
| `nlf_​noise_​013` | sinus | `15473_hr` | `em` @ +6 dB | 12 | 0 | **limited** | — |
| `nlf_​noise_​014` | afib | `15535_hr` | `ma` @ +12 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​015` | pac pvc | `15877_hr` | `bw` @ +18 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​016` | bbb conduction | `16615_hr` | `em` @ -6 dB | 12 | 12 | **reject** | yes |
| `nlf_​noise_​017` | st t | `16930_hr` | `ma` @ +0 dB | 6 | 0 | **limited** | yes |
| `nlf_​noise_​018` | flutter svt | `17553_hr` | `bw` @ +6 dB | 6 | 0 | **limited** | — |
| `nlf_​noise_​019` | sinus | `17727_hr` | `em` @ +12 dB | 12 | 0 | **diagnostic** | — |
| `nlf_​noise_​020` | afib | `17770_hr` | `ma` @ +18 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​021` | pac pvc | `17867_hr` | `bw` @ -6 dB | 6 | 6 | **limited** | yes |
| `nlf_​noise_​022` | bbb conduction | `18284_hr` | `em` @ +0 dB | 12 | 0 | **limited** | yes |
| `nlf_​noise_​023` | st t | `18508_hr` | `ma` @ +6 dB | 6 | 0 | **limited** | — |
| `nlf_​noise_​024` | flutter svt | `19002_hr` | `bw` @ +12 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​025` | sinus | `19238_hr` | `em` @ +18 dB | 12 | 0 | **diagnostic** | — |
| `nlf_​noise_​026` | afib | `01979_hr` | `ma` @ -6 dB | 6 | 6 | **limited** | yes |
| `nlf_​noise_​027` | pac pvc | `20943_hr` | `bw` @ +0 dB | 6 | 0 | **limited** | yes |
| `nlf_​noise_​028` | bbb conduction | `20977_hr` | `em` @ +6 dB | 12 | 0 | **limited** | — |
| `nlf_​noise_​029` | st t | `21495_hr` | `ma` @ +12 dB | 6 | 0 | **diagnostic** | — |
| `nlf_​noise_​030` | flutter svt | `21820_hr` | `bw` @ +18 dB | 6 | 0 | **diagnostic** | — |
...
|:--|:--|:--|:--|--:|:--:|:--:|
| `nlf_​eng_​001_​emg_​v1` | `02965_hr` | swing 6 mV p2p (V1) | — | 1 | **limited** | — |
| `nlf_​eng_​002_​macecg_​walk_​v2` | `03016_hr` | MACECGDB `walk` swing 8 mV p2p (V2) | — | 1 | **limited** | — |
| `nlf_​eng_​003_​intermittent_​v6` | `03047_hr` | intermittent lead-off with reconnection (V6) | intermittent lead off | 1 | **limited** | — |
| `nlf_​eng_​004_​step_​ii` | `03365_hr` | baseline step 4 mV, tau=1 s (II) | — | 0 | **limited** | — |
| `nlf_​eng_​005_​macecg_​jump_​overload_​v3` | `03427_hr` | MACECGDB `jump` swing 30 mV p2p (V3) → rail ±5 mV | rail saturation | 1 | **limited** | — |
| `nlf_​eng_​006_​flatline_​v4` | `03543_hr` | flatline / zero-fill (V4) | flatline zero | 1 | **limited** | — |
| `nlf_​eng_​007_​constant_​v5` | `03687_hr` | stuck constant 1.2 mV (V5) | constant adc | 1 | **limited** | — |
| `nlf_​eng_​008_​missing_​v6` | `03730_hr` | digital-missing / NaN (V6) | digital missing channel | 1 | **limited** | — |
| `nlf_​eng_​009_​flatline_​i` | `03941_hr` | flatline / zero-fill (I) | flatline zero | 5 | **limited** | — |
| `nlf_​eng_​010_​leadoff_​v2` | `04593_hr` | lead-off (V2) | lead off | 1 | **limited** | — |
| `nlf_​eng_​011_​emg_​burst_​v5` | `00476_hr` | swing 5 mV p2p (V5), t in [3,6] s | — | 0 | **limited** | — |
| `nlf_​eng_​021_​reversal_​i` | `09509_hr` | polarity inversion (I) | — | 0 | **limited** | — |
...
| Record | PTB-XL parent | Corruption | Integrity failure | Bad leads | Expected quality | Discard |
|:--|:--|:--|:--|--:|:--:|:--:|
| `nlf_​eng_​012_​couple_​v1v2` | `05267_hr` | precordial coupling V1, V2 @ +0 dB | — | 2 | **limited** | — |
| `nlf_​eng_​013_​couple_​v4v5` | `05298_hr` | precordial coupling V4, V5 @ +6 dB | — | 0 | **limited** | — |
| `nlf_​eng_​014_​triple_​v1v2v3` | `05887_hr` | precordial coupling V1, V2, V3 @ -6 dB | — | 3 | **limited** | yes |
| `nlf_​eng_​015_​electrode_​la` | `06175_hr` | LA electrode motion 1 mV | — | 4 | **limited** | yes |
| `nlf_​eng_​016_​electrode_​ra` | `06526_hr` | RA electrode offset 3 mV | — | 6 | **reject** | yes |
| `nlf_​eng_​017_​saturate_​v2v3` | `06789_hr` | overload swing 30 mV p2p (V2, V3) → rail ±5 mV | rail saturation | 2 | **limited** | — |
| `nlf_​eng_​018_​saturate_​v4v5v6` | `07086_hr` | overload swing 30 mV p2p (V4, V5, V6) → rail ±5 mV | rail saturation | 3 | **limited** | yes |
| `nlf_​eng_​019_​electrode_​ll` | `08699_hr` | LL electrode motion 1.2 mV | — | 3 | **limited** | yes |
| `nlf_​eng_​020_​compound_​wild` | `08931_hr` | LA electrode motion 0.8 mV ; MACECGDB `walk` swing 8 mV p2p (V2) ; lead-off (V5) | lead off | 5 | **limited** | yes |
| `nlf_​eng_​022_​mixed_​integrity` | `09915_hr` | digital-missing / NaN (V1) ; overload swing 25 mV p2p (V6) → rail ±5 mV ; baseline step 3 mV, tau=1.5 s (II) | digital missing channel | 2 | **limited** | — |
...
*Generated by Artefaux v1.0.0 (<https://github.com/depolarised/artefaux>) via
