...
recipe-authored labels, so no number in the report can drift from the source.
    ...
    python scripts/reports/generate_corpus_report.py            # -> reports/artefaux_v2_corpus_report.md
...
- **Counts:** {n} records ({n_nat} / {n_noise} / {n_eng}) + 70 paired clean parents.
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--output", default=str(REPO / "reports" / "artefaux_v2_corpus_report.md"))
